 ...
 */
export declare const DEFAULT_CONTAINER_CONFIG: Partial<ContainerConfig>;
/**
 * Default MConnect dev container image
 */
export declare const MCONNECT_DEFAULT_IMAGE = "ubuntu:22.04";
/**
 * Default container security profile
 */
export declare const DEFAULT_SECURITY_PROFILE: ContainerSecurityProfile;
